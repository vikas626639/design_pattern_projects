...
public class ChennaiBajajBikeFactory {
	...
	public static  void paint() {
		System.out.println("ChennaiBajajBikeFactory.paint()-->painting the bike");
	}
	
	public static void Assemble() {
		System.out.println("ChennaiBajajBikeFactory.Assemble()--> assembling the bike");
	}
	
	public static void Oiling() {
		System.out.println("ChennaiBajajBikeFactory.Oiling()----> oiling the bike");
	}
	
	public static void roadTest() {
		System.out.println("ChennaiBajajBikeFactory.roadTest()--> roadtesting the bike");
	}
